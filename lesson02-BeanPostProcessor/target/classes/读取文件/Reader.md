...
/**
 * 读取给定的一系列@Configuration的实例，然后将这些Bean的定义注册到BeanDefinitionRegistry上。
 * 这个类是基于BeanDefinitionReader进行建模的，但是并没有实现，也没所有继承BeanDefinitionReader
 * 的任何方法。因为Java Bean是Configuration类，而不是Resource(资源文件)
 */
class ConfigurationClassBeanDefinitionReader {
   ...
   /**
    * 创建一个可用于填充BeanDefinitionRegistry的ConfigurationClassBeanDefinitionReader实例
    */
   ...
   /**
    * 读取configurationModel，并将这些bean的定义注册到BeanDefinitionRegistry
    */
